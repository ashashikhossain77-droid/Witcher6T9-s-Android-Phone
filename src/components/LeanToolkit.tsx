...
export const LeanToolkit: React.FC<LeanToolkitProps> = ({
  ...
  const [methodSelect, setMethodSelect] = useState('5s-audit');
  const [targetLine, setTargetLine] = useState('18');
  ...
  // If a tool workspace is open, show the dedicated interactive tool workspace
  if (activeMethod) {
    return (
      <LeanToolWorkspace
        method={activeMethod}
    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      {viewMode === 'tools' ? (
        <div className="space-y-4">
          ...
          {/* 12 Tools List - Exactly matching the screenshot design */}
